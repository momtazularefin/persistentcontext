...
function addSignal(signals, code, category, candidatePath, reason, strength) {
...
function representativeSignal(signals, code, category, paths, reason, strength) {
  const first = [...paths].sort(comparePortablePaths)[0];
  if (first !== void 0) addSignal(signals, code, category, first, reason, strength);
}
...
var PCP_RELEASE_STAGE = "inspection";
var PCP_COMMANDS = [
  "inspect",
  "adopt",
  "register",
...
function reportInspectionError(error) {
