...
- Added normalized preview-only State C translation plans with coverage-bound digests, explicit canonical writes/replacements, fingerprinted foreign-file removals, and file-to-directory collision ordering; apply remains disabled.
