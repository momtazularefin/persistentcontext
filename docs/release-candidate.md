...
| Three-state intake   | Inspection, adoption planner/transaction tests, evidence-backed State C root scoping and coverage tests, and the FlowForge State B example cover managed and A/B/C routing.                          |
